...
## 「パイプライン」語の使用箇所（CLAUDE.md のルールに従い要確認）

`pipeline.md` 以外での使用箇所（直すかどうかは別途判断）:

- `design.md`:5
- `CLAUDE.md`:5, 20
- `TODO.md`:41
- `templates/default/deck.md`:19
- `examples/intro/deck.md`:447, 453

README.md は今回の刷新で大半を解消。
